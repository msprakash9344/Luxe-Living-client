...
function Login() {
    return(
      <>
        <div className="container-fluid mt-5 p-5 bg-light shadow">
            <div className="row signup-container">

                {/* Left Section */}
                <div className="col-md-6 login-left-section">
                    <div>
                        <h2>Welcome Back!</h2>
                        <p>Log in to access exclusive furniture deals and updates!</p>
                    </div>
                </div>
                ...
                <div className="col-md-6 right-section">
                    <form style={{ width: "100%", maxWidth: "400px" }}>
                        ...
                        <button type="submit" className="btn btn-custom mb-2">LOGIN</button>
                        <p className="text-center mt-2">New User? <a href="/signup" className="text-decoration-none">Create an account</a></p>
                    </form>
                </div>
            </div>
        </div>
